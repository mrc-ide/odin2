test_that("can generate adjoint model", {
  ...
  expect_equal(
    ...
    c(method_args$adjoint_update,
      ...
      "  adjoint_next[1] = adj_I + adj_n_IR * p_IR + adj_p_SI * shared.beta * dt * monty::math::exp<real_type>(-shared.beta * I * dt / shared.N) / shared.N;",
      "  adjoint_next[2] = adj_R;",
      "  adjoint_next[3] = adj_cases_inc;",
      "  adjoint_next[4] = adj_p_SI * I * dt * monty::math::exp<real_type>(-shared.beta * I * dt / shared.N) / shared.N + adj_beta;",
      "  adjoint_next[5] = adj_p_IR * dt * monty::math::exp<real_type>(-shared.gamma * dt) + adj_gamma;",
