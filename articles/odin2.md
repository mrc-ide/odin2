...
where $`S`$ is the number of susceptibles, $`I`$ is the number of
infected and $`R`$ is the number recovered; the total population size
$`N = S + I + R`$ is constant. $`\beta`$ is the infection rate,
$`\gamma`$ is the recovery rate.

Discretising this model in time steps of width $`dt`$ gives the
following update equations for each time step:
...
#> g++ -std=gnu++20 -I"/opt/R/4.6.0/lib/R/include" -DNDEBUG  -I'/home/runner/work/_temp/Library/cpp11/include' -I'/home/runner/work/_temp/Library/dust2/include' -I'/home/runner/work/_temp/Library/monty/include' -I/usr/local/include   -DHAVE_INLINE -fopenmp  -fpic  -g -O2  -Wall -pedantic -fdiagnostics-color=always  -c cpp11.cpp -o cpp11.o
#> g++ -std=gnu++20 -I"/opt/R/4.6.0/lib/R/include" -DNDEBUG  -I'/home/runner/work/_temp/Library/cpp11/include' -I'/home/runner/work/_temp/Library/dust2/include' -I'/home/runner/work/_temp/Library/monty/include' -I/usr/local/include   -DHAVE_INLINE -fopenmp  -fpic  -g -O2  -Wall -pedantic -fdiagnostics-color=always  -c dust.cpp -o dust.o
#> g++ -std=gnu++20 -shared -L/opt/R/4.6.0/lib/R/lib -L/usr/local/lib -o odin.system9a8a577a.so cpp11.o dust.o -fopenmp -L/opt/R/4.6.0/lib/R/lib -lR
#> installing to /tmp/RtmpmopSQx/devtools_install_204c7ad49d6c/00LOCK-dust_204c3b6954d0/00new/odin.system9a8a577a/libs
