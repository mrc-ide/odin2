...
Disallowed use of named arguments.  For some primative R functions (e.g., `+` we disallow use of named argument forms).  You are unlikely to see this error, but we would be interested to know if you do.
