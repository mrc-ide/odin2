...
# Source: https://github.com/reside-ic/reside.utils/blob/HEAD/R/standalone-error-render.R
# Generated by: usethis::use_standalone("reside-ic/reside.utils", "error-render")
# ----------------------------------------------------------------------
#
# ---
